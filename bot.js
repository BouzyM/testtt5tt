...
client.user.setGame(`Prefix $ | Discord School`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            .setColor("RANDOM")
            .setThumbnail(message.author.avatarURL)
            .setDescription(`**__Discord School Bc,| Version 1.1__ 
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/Zut8DV
            **`);
